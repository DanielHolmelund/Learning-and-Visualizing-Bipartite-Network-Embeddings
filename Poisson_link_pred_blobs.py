...
if __name__ == "__main__":
    ...
    for _ in range(iterations):
        ...
        loss_test = -model.test_log_likelihood(test_idx_i, test_idx_j, test_value) / 100000
        cum_loss_test.append(loss_test.item())

        optimizer.zero_grad()
        loss.backward()
        optimizer.step()
        cum_loss_train.append(loss.item() / (model.input_size[0]*model.input_size[1]-100000))
        print(_)
        '''if _ % 1000 == 0:
